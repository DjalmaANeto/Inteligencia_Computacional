...
public class Adaline {
    ...
    public static void main(String[] args) {
        Adaline treinamento = new Adaline();
    ...
    public double[] executarFaseTreinamento(double [][] amostras, double [] saida){
        ...
        double[] pesos = new double[saida.length];
        ...
        do {
            ...
            eqmAnterior = Eqm.calculateEQM(amostras, saida, pesos);
            ...
            for (int k = 0; k < amostras.length; k++) {
                ...
                for (int i = 0; i < pesos.length; i++) {
                    pesos[i] = pesos[i] + taxaAprendizado * (saida[k] - u) * amostras[i][k];
                }
            }
            ...
            eqmAtual = Eqm.calculateEQM(amostras, saida, pesos);
